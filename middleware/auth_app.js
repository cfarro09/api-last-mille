...
module.exports = async function (req, res, next) {
    ...
    try {
        ...
        console.log('user', cifrado.user)

        const result = await tf.executesimpletransaction("UFN_USERTOKEN_SEL", {...cifrado.user, update: false, origin: 'APP'}, false, undefined, true);
